...
gerar.addEventListener('click', () => {
    ...
    res.innerHTML = `<br><br> Números gerados [ ${array} ]`
...
ordenar.addEventListener('click', () => {
    ...
    let soma = c1 + c2
    res2.innerHTML = `<br><br> Array Ordenado: [ ${array} ] ,ele realizou em: ${soma} movimentos`
    res2.style.fontSize = 'larger'
})
inverter.addEventListener('click', () => {
    ...
    res3.innerHTML = `<br><br> Array Invertido: [ ${array} ]`
    res3.style.fontSize = 'larger'
})